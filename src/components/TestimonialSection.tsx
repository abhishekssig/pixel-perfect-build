...
const testimonials = [
  ...
  { name: "Kenji Tanaka", company: "Sakura Studios", role: "Creative Director", avatar: "https://i.pravatar.cc/80?img=11", quote: "反逆のデザイン哲学が大好きです。The Rebel Pad Pro's gyroscope is a game changer for aim-assisted shooters. Hall Effect triggers seal the deal." },
  ...
  { name: "Yuki Sato", company: "Kaze Tech", role: "Hardware Engineer", avatar: "https://i.pravatar.cc/80?img=15", quote: "品質に妥協なし。As an engineer, I appreciate the internal design. Clean PCB layout, quality components, and the haptic motor integration is clever." },
  ...
  { name: "Hana Kimura", company: "Ronin Labs", role: "Sound Engineer", avatar: "https://i.pravatar.cc/80?img=44", quote: "音質が素晴らしい。The planar magnetic drivers in the headset deliver audiophile-grade sound. LDAC codec support is rare at this price point." },
  ...
  { name: "Sakura Ito", company: "Neon Drift", role: "Art Director", avatar: "https://i.pravatar.cc/80?img=47", quote: "日本のデザイン精神を完璧に体現。Every product feels like a piece of art. The attention to detail in the packaging alone tells you this brand cares." },
];
