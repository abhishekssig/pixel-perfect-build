...
const FEATURES = [
  { icon: "🎧", title: "50mm", subtitle: "PLANAR MAGNETIC DRIVER", color: "text-red-500" },
  { icon: "🔇", title: "ANC", subtitle: "HYBRID NOISE CANCEL", color: "text-red-400" },
  { icon: "🌐", title: "SPATIAL", subtitle: "7.1 SURROUND SOUND", color: "text-red-500" },
  { icon: "🎙️", title: "DUAL MIC", subtitle: "AI NOISE ISOLATION", color: "text-red-400" },
  { icon: "🔋", title: "60 HRS", subtitle: "MARATHON BATTERY", color: "text-red-500" },
  { icon: "📱", title: "MULTIPOINT", subtitle: "CONNECT 3 DEVICES", color: "text-red-400" },
];
    ...
    <div className="min-h-[600vh] bg-[#1a1a1a] text-white">
        ...
        <div className="flex-1 z-10 pt-10 md:pt-0 flex flex-col justify-center">
          ...
          <div className="transition-all duration-700 ease-out" style={{ opacity: showDesc ? 1 : 0, transform: showDesc ? "translateY(0)" : "translateY(20px)" }}>
            ...
            <p className="text-white/70 text-sm md:text-base max-w-sm leading-relaxed">
              Premium over-ear headset with planar magnetic drivers, hybrid ANC, and 7.1 spatial audio — crafted for audiophiles and competitive gamers alike.
            </p>
          </div>
          ...
          <div className="mt-6 transition-all duration-700 ease-out" style={{ opacity: showPrice ? 1 : 0, transform: showPrice ? "translateY(0)" : "translateY(20px)" }}>
            ...
            <p className="text-2xl md:text-3xl font-light mb-4">INR 3,500.93</p>
            <button onClick={() => addToCart({ id: 104, name: "Rebel Head Pro", price: 3500.93, img: headphonesImg })} className="flex items-center gap-3 px-6 py-3 rounded-full border border-white/20 bg-white/5 backdrop-blur-sm text-white text-sm tracking-wide hover:bg-white/10 transition-colors">
              <span>Add to Cart</span><span className="text-lg">🛒</span>
            </button>
          </div>
        </div>
        <div className="flex-1 flex items-center justify-center relative">
          <img src={headphonesImg} alt="Rebel Head Pro" className="w-[260px] md:w-[360px] lg:w-[420px] object-contain drop-shadow-2xl" />
        </div>
      ...
      <div className="fixed inset-0 z-20 pointer-events-none" style={{ transform: `translateY(${100 - drawerProgress * 100}%)` }}>
        <div className="w-full h-full bg-[#0a0a0a] pointer-events-auto flex flex-col items-center justify-center px-6 md:px-16">
          <p className="text-white/20 text-sm tracking-widest mb-10">FEATURES</p>
          ...
          <div className="grid grid-cols-2 gap-x-16 md:gap-x-32 max-w-4xl w-full">
            <div style={{ opacity: specsProgress > 0.5 ? 1 : 0, transform: specsProgress > 0.5 ? "translateY(0)" : "translateY(30px)", transition: "all 0.6s ease-out" }}>
              ...
              <ul className="space-y-3 text-white/70 text-sm mb-10">
                <li className="flex items-start gap-2"><span className="text-red-500 mt-1">•</span> Rebel Head Pro Headset x 1</li>
                <li className="flex items-start gap-2"><span className="text-red-500 mt-1">•</span> USB-C Charging Cable x 1</li>
                <li className="flex items-start gap-2"><span className="text-red-500 mt-1">•</span> 3.5mm Audio Cable x 1</li>
                <li className="flex items-start gap-2"><span className="text-red-500 mt-1">•</span> Carrying Pouch x 1</li>
              </ul>
              <h2 className="text-2xl md:text-3xl font-light italic mb-6">Dimensions</h2>
              <ul className="space-y-3 text-white/70 text-sm">
                <li className="flex items-start gap-2"><span className="text-red-500 mt-1">•</span> Width: 7.5in (190mm)</li>
                <li className="flex items-start gap-2"><span className="text-red-500 mt-1">•</span> Height: 8.2in (208mm)</li>
                <li className="flex items-start gap-2"><span className="text-red-500 mt-1">•</span> Depth: 3.5in (89mm)</li>
                <li className="flex items-start gap-2"><span className="text-red-500 mt-1">•</span> Weight: 310g</li>
              </ul>
            </div>
            <div style={{ opacity: specsProgress > 0.5 ? 1 : 0, transform: specsProgress > 0.5 ? "translateY(0)" : "translateY(30px)", transition: "all 0.6s ease-out 0.15s" }}>
              <h2 className="text-2xl md:text-3xl font-light italic mb-6">Specifications</h2>
              <ul className="space-y-3 text-white/70 text-sm">
                <li className="flex items-start gap-2"><span className="text-red-500 mt-1">•</span> Driver: 50mm Planar Magnetic</li>
                <li className="flex items-start gap-2"><span className="text-red-500 mt-1">•</span> Frequency: 20Hz – 40kHz</li>
                <li className="flex items-start gap-2"><span className="text-red-500 mt-1">•</span> ANC: Hybrid Active Noise Cancel</li>
                <li className="flex items-start gap-2"><span className="text-red-500 mt-1">•</span> Surround: 7.1 Spatial Audio</li>
                <li className="flex items-start gap-2"><span className="text-red-500 mt-1">•</span> Microphone: Dual AI Noise Isolation</li>
                <li className="flex items-start gap-2"><span className="text-red-500 mt-1">•</span> Battery: 60hrs (ANC off)</li>
                <li className="flex items-start gap-2"><span className="text-red-500 mt-1">•</span> Codec: LDAC / aptX Adaptive</li>
              </ul>
            </div>
          </div>
        </div>
